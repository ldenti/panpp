...
public:
  ...
  // The input data is expected to contain end markers, but they are not
  // included in the suffix array. Unlike in RLCSA, there is no padding between
  // the sequences. In the last two constructors, the ownership of data is
  // transfered to the suffix array. The third version assumes that the rank
  // array has unique lexicographic ranks for all suffixes.
