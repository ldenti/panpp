...
// #define MASSIVE_DATA_RLCSA    // usint and sint become 64-bit in a 64-bit
// environment.
...
inline usint popcount(usint field) { return __builtin_popcountl(field); }
...
inline usint popcount(usint field) { return __builtin_popcount(field); }
...
inline bool isEmpty(const pair_type data) { return (data.first > data.second); }
